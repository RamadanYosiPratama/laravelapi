...
class TransaksiMasukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // input berdasarkan produk yang bakal di create stok bertambah otomatis

        $produk = Produk::find($input['kd_produk']);
        $data['stok'] = $produk->stok + $input['jumlah'];
        $produk->update($data);

        return redirect()->route('transaksi_masuk.index')->with('status','Transaksi Masuk Berhasil Di tambahkan');
    ...
    public function destroy($id)
    {
        ...
        // kalo di hapus yang di produk auto hapus
